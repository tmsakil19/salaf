...
export function OverviewCard({ card }: OverviewCardProps) {
  ...
  return (
    <div className="flex flex-col gap-2 rounded-xl border border-[#ebebeb] bg-white p-4 shadow-[0px_1px_2px_0px_rgba(10,13,20,0.03)]">
      <div
        className={cn(
      ...
      <p className="text-2xl font-semibold leading-6 tracking-[-0.36px] text-[#171717]">
        {card.value}
      </p>
    </div>
  );
